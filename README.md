## 👨‍💻 About Project :
✔ Updating React {Native} && Implementing hooks and functional components for better code optimisation and smooth UI.
...
<p align="left"> 
    ...
    <a href="https://play.google.com/store/apps/details?id=com.moglix.online&hl=en_IN&gl=US" target="_blank"> <img src="https://img.icons8.com/color/48/000000/google-play.png"/> </a>
...
### Got Stuck with JDK/SDK? 😇
Checkout this command : curl -s "https://get.sdkman.io" | bash source "$HOME/.sdkman/bin/sdkman-init.sh" sdk install java 11.0.2-open
